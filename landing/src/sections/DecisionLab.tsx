...
import { DEMO_ROUTE, PREVIEW_LABEL, isLiveBackend } from '../config/endpoints';
          ...
          <div className="flex flex-wrap items-center gap-4 border-t border-hairline bg-surface-2/40 px-4 py-4 sm:px-6">
            <p className="font-mono text-[10.5px] leading-relaxed text-ink-faint">
              {isLiveBackend
                ...
                : 'Running on local demo data. Connect an API base URL to stream real decisions.'}
            </p>
            <ButtonLink href={DEMO_ROUTE} size="sm" className="ml-auto">
