...
export default function RiskMeter({ risk, modelVersion, unavailable, compact }) {
    ...
    <div>
      <div className="mb-1 flex items-baseline justify-between gap-2">
        ...
        <span className={`font-mono text-[10px] font-bold ${tone.text}`}>
          {tone.word}{unavailable ? ' · UNAVAILABLE' : ''}
        </span>
      </div>
      <div className="relative h-2 overflow-hidden rounded-full bg-sunken ring-1 ring-line">
        ...
        {/* Ticks mark the numbers the decision actually turns on. */}
